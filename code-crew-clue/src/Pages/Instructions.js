...
function Instructions() {
  return (
    <div className="instructions-container">
      ...
      <p>1. Read each suspects description. This will include motive and weapon of choice</p>
      <p>2. Read all 5 clues</p>
      <p>3. You get 2 guesses to figure out who killed the code crew member</p>
